...
class TestWordData:
    ...
    def test_probability_calculation(self):
        ...
        prob_rare = word_rare.calculate_probability(
            100, 50, min_word_count=5, new_word_score=0.4
        )
    ...
    def test_update_counts(self):
        ...
        assert (
            word.last_update >= original_time
        )  # Use >= instead of > for more reliable test
...
class TestWordDatabase:
    ...
    def test_cleanup_operations(self):
        ...
        updates = {"common": (10, 5), "rare1": (1, 1), "rare2": (2, 0), "old": (1, 0)}
        self.db.update_word_counts(updates)
    ...
    def test_purge_operations(self):
        ...
        updates = {"common": (10, 5), "uncommon": (3, 2), "rare": (1, 1)}
        self.db.update_word_counts(updates)
    ...
    def test_export_import(self):
        ...
        # Add some test data
        updates = {"word1": (5, 3), "word2": (2, 8), "word3": (10, 1)}
        self.db.update_word_counts(updates)
