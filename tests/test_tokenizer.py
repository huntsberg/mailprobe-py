...
""")
    ...
    def test_header_prefixes(self):
        ...
        message = EmailMessage("""From: sender@example.com
...
""")
    ...
    def test_phrase_generation(self):
        ...
        message = EmailMessage("""Subject: Free money offer
...
""")
    ...
    def test_html_removal(self):
        ...
        message = EmailMessage("""Subject: HTML message
...
""")
    ...
    def test_url_extraction(self):
        ...
        message = EmailMessage("""Subject: URLs
...
""")
    ...
    def test_non_ascii_replacement(self):
        ...
        tokenizer = EmailTokenizer(replace_non_ascii='z', min_term_length=1)  # Lower min length
        message = EmailMessage("""Subject: Tëst mëssagë
...
""")
        ...
        expected_tokens = ['tzst', 'mzssagz', 'hzllz', 'wzrld', 'ssag', 'rld']  # Include filtered versions
    ...
    def test_ignore_body(self):
        ...
        message = EmailMessage("""Subject: Header only
