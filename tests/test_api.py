...
"""
    ...
    def test_classify_message_object(self):
        ...
        message = EmailMessage("""From: test@example.com
Subject: Test
...
"""
    ...
    def test_database_operations(self):
        ...
        # Train some messages
        self.api.train_message("From: test@example.com\nSubject: Test\n\nHello", is_spam=False)
    ...
    def test_cleanup_database(self):
        ...
        # Train some messages
        for i in range(3):
            self.api.train_message(f"From: test{i}@example.com\nSubject: Test {i}\n\nMessage {i}", is_spam=False)
...
class TestBatchMailFilter:
    ...
    def test_classify_batch(self):
        ...
        detailed_results = self.batch_filter.classify_batch(messages, return_details=True)
...
class TestConvenienceFunctions:
    ...
    def test_train_from_directories_function(self):
        ...
        (good_dir / "email1.txt").write_text("From: friend@example.com\nSubject: Meeting\n\nLet's meet")
        (good_dir / "email2.txt").write_text("From: colleague@example.com\nSubject: Project\n\nProject update")
        
        (spam_dir / "spam1.txt").write_text("From: spammer@bad.com\nSubject: FREE MONEY\n\nClick here!")
        (spam_dir / "spam2.txt").write_text("From: scammer@evil.com\nSubject: URGENT\n\nYou won!")
