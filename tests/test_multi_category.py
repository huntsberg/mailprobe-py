...
class TestFolderBasedClassifier:
    ...
    def test_move_email_to_folder(self):
        ...
        test_email_path.write_text("From: test@example.com\nSubject: Test\n\nTest email.")
    ...
    def test_classify_and_move(self):
        ...
        # Create test email file
        test_email_path = Path(self.temp_dir) / "test_email.txt"
        test_email_path.write_text("From: boss@company.com\nSubject: Urgent\n\nUrgent work matter.")
        ...
        with FolderBasedClassifier(self.base_path) as classifier:
            ...
            result, moved_path = classifier.classify_and_move(test_email_path, confidence_threshold=0.0)
...
class TestConvenienceFunctions:
    ...
    def test_train_from_folder_structure(self):
        ...
        for category in ['work', 'personal']:
            ...
            email_file.write_text(f"From: test@{category}.com\nSubject: Test\n\nTest {category} email.")
