...
class MailProbeAPI:
    ...
    def classify(self, 
                 ...
                 return_details: bool = False) -> Union[bool, ClassificationResult]:
        """
    ...
    def get_spam_probability(self, message_source: Union[str, Path, EmailMessage]) -> float:
        """
    ...
    def train_good(self, 
                   ...
                   force_update: bool = False) -> TrainingResult:
        """
    ...
    def _get_messages_from_source(self, source: Union[str, Path, List[Union[str, Path]]]) -> List[EmailMessage]:
...
class BatchMailFilter:
    ...
    def classify_batch(self, 
                      ...
                      return_details: bool = False) -> List[Union[bool, ClassificationResult]]:
        """
            ...
            try:
                ...
                if return_details:
                    results.append(ClassificationResult(
                        is_spam=False, probability=0.5, confidence=0.0,
                        terms_used=0, digest="", top_terms=[]
                    ))
                else:
    ...
    def train_batch(self, 
                   ...
                   selective: bool = False) -> Dict[str, TrainingResult]:
        """
...
def classify_email(email_content: str, 
                  database_path: Optional[Union[str, Path]] = None) -> bool:
    """
...
def train_from_directories(good_dir: Union[str, Path],
                          spam_dir: Union[str, Path],
                          database_path: Optional[Union[str, Path]] = None) -> Dict[str, TrainingResult]:
    """
...
def get_spam_probability(email_content: str,
                        database_path: Optional[Union[str, Path]] = None) -> float:
    """
