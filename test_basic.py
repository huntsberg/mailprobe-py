...
def main():
    ...
    good_message = EmailMessage("""From: friend@example.com
...
""")
    ...
    spam_message = EmailMessage("""From: spammer@badsite.com
...
""")
    ...
    test_good = EmailMessage("""Subject: Project meeting

Let's discuss the project timeline.""")
    
    test_spam = EmailMessage("""Subject: URGENT!!!
...
FREE money! Click now! Limited offer!""")
    ...
    print(f'Good message score: {good_score.probability:.3f} (spam: {good_score.is_spam})')
    print(f'Spam message score: {spam_score.probability:.3f} (spam: {spam_score.is_spam})')
