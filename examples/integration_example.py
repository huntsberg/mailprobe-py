...
def advanced_integration_example():
    ...
    class MyEmailProcessor:
        ...
        def process_email(self, email_content, sender_whitelist=None):
            ...
            if sender_whitelist and self._is_whitelisted(
                email_content, sender_whitelist
            ):
                return {
                    "action": "deliver",
                    "reason": "whitelisted",
        ...
        def train_from_user_feedback(self, email_content, user_marked_as_spam):
            ...
            return self.spam_filter.train_message(
                email_content, user_marked_as_spam, force_update=True
            )
